...
public class TreeMap<K,V> extends AbstractSortedMap<K,V> {
  ...
  protected static class BalanceableBinaryTree<K,V>
                         extends LinkedBinaryTree<net.datastructures.Entry<K,V>> {
    ...
    public int getAux(Position<net.datastructures.Entry<K,V>> p) {
      return ((BSTNode<net.datastructures.Entry<K,V>>) p).getAux();
    }

    public void setAux(Position<net.datastructures.Entry<K,V>> p, int value) {
      ((BSTNode<net.datastructures.Entry<K,V>>) p).setAux(value);
    }

    // Override node factory function to produce a BSTNode (rather than a Node)
    @Override
    protected
    Node<net.datastructures.Entry<K,V>> createNode(net.datastructures.Entry<K,V> e, Node<net.datastructures.Entry<K,V>> parent,
                                                   Node<net.datastructures.Entry<K,V>> left, Node<net.datastructures.Entry<K,V>> right) {
      return new BSTNode<>(e, parent, left, right);
    }

    /** Relinks a parent node with its oriented child node. */
    private void relink(Node<net.datastructures.Entry<K,V>> parent, Node<net.datastructures.Entry<K,V>> child,
     ...
     */
    public void rotate(Position<net.datastructures.Entry<K,V>> p) {
      Node<net.datastructures.Entry<K,V>> x = validate(p);
      Node<net.datastructures.Entry<K,V>> y = x.getParent();        // we assume this exists
      Node<net.datastructures.Entry<K,V>> z = y.getParent();        // grandparent (possibly null)
      if (z == null) {
     ...
     */
    public Position<net.datastructures.Entry<K,V>> restructure(Position<net.datastructures.Entry<K,V>> x) {
      Position<net.datastructures.Entry<K,V>> y = parent(x);
      Position<net.datastructures.Entry<K,V>> z = parent(y);
  ...
  private void expandExternal(Position<net.datastructures.Entry<K,V>> p, net.datastructures.Entry<K,V> entry) {
  ...
  protected Position<net.datastructures.Entry<K,V>> root() { return tree.root(); }
  protected Position<net.datastructures.Entry<K,V>> parent(Position<net.datastructures.Entry<K,V>> p) { return tree.parent(p); }
  protected Position<net.datastructures.Entry<K,V>> left(Position<net.datastructures.Entry<K,V>> p) { return tree.left(p); }
  protected Position<net.datastructures.Entry<K,V>> right(Position<net.datastructures.Entry<K,V>> p) { return tree.right(p); }
  protected Position<net.datastructures.Entry<K,V>> sibling(Position<net.datastructures.Entry<K,V>> p) { return tree.sibling(p); }
  protected boolean isRoot(Position<net.datastructures.Entry<K,V>> p) { return tree.isRoot(p); }
  protected boolean isExternal(Position<net.datastructures.Entry<K,V>> p) { return tree.isExternal(p); }
  protected boolean isInternal(Position<net.datastructures.Entry<K,V>> p) { return tree.isInternal(p); }
  protected void set(Position<net.datastructures.Entry<K,V>> p, net.datastructures.Entry<K,V> e) { tree.set(p, e); }
  protected net.datastructures.Entry<K,V> remove(Position<net.datastructures.Entry<K,V>> p) { return tree.remove(p); }
  protected void rotate(Position<net.datastructures.Entry<K,V>> p) { tree.rotate(p); }
  protected Position<net.datastructures.Entry<K,V>> restructure(Position<net.datastructures.Entry<K,V>> x) { return tree.restructure(x); }
   ...
   */
  protected Position<net.datastructures.Entry<K,V>> treeMin(Position<net.datastructures.Entry<K,V>> p) {
    Position<net.datastructures.Entry<K,V>> walk = p;
   ...
   */
  protected Position<net.datastructures.Entry<K,V>> treeMax(Position<net.datastructures.Entry<K,V>> p) {
    Position<net.datastructures.Entry<K,V>> walk = p;
    while (isInternal(walk))
      walk = right(walk);
    return parent(walk);              // we want the parent of the leaf
  ...
  public V get(K key) throws IllegalArgumentException {
    ...
    Position<net.datastructures.Entry<K,V>> p = treeSearch(root(), key);
  ...
  public V put(K key, V value) throws IllegalArgumentException {
    checkKey(key);                          // may throw IllegalArgumentException
    net.datastructures.Entry<K,V> newEntry = new MapEntry<>(key, value);
    Position<net.datastructures.Entry<K,V>> p = treeSearch(root(), key);
  ...
  public V remove(K key) throws IllegalArgumentException {
    ...
    if (isExternal(p)) {                    // key not found
      ...
      if (isInternal(left(p)) && isInternal(right(p))) { // both children are internal
        Position<net.datastructures.Entry<K,V>> replacement = treeMax(left(p));
        set(p, replacement.getElement());
        p = replacement;
      } // now p has at most one child that is an internal node
      Position<net.datastructures.Entry<K,V>> leaf = (isExternal(left(p)) ? left(p) : right(p));
      Position<net.datastructures.Entry<K,V>> sib = sibling(leaf);
      remove(leaf);
   ...
   */
  @Override
  public net.datastructures.Entry<K,V> firstEntry() {
   ...
   */
  @Override
  public net.datastructures.Entry<K,V> lastEntry() {
    if (isEmpty()) return null;
   ...
   */
  @Override
  public net.datastructures.Entry<K,V> ceilingEntry(K key) throws IllegalArgumentException {
    checkKey(key);                              // may throw IllegalArgumentException
    Position<net.datastructures.Entry<K,V>> p = treeSearch(root(), key);
   ...
   */
  @Override
  public net.datastructures.Entry<K,V> floorEntry(K key) throws IllegalArgumentException {
    checkKey(key);                              // may throw IllegalArgumentException
    Position<net.datastructures.Entry<K,V>> p = treeSearch(root(), key);
    if (isInternal(p)) return p.getElement();   // exact match
    while (!isRoot(p)) {
   ...
   */
  @Override
  public net.datastructures.Entry<K,V> lowerEntry(K key) throws IllegalArgumentException {
    checkKey(key);                              // may throw IllegalArgumentException
    Position<net.datastructures.Entry<K,V>> p = treeSearch(root(), key);
   ...
   */
  @Override
  public net.datastructures.Entry<K,V> higherEntry(K key) throws IllegalArgumentException {
    checkKey(key);                               // may throw IllegalArgumentException
    Position<net.datastructures.Entry<K,V>> p = treeSearch(root(), key);
   ...
   */
  @Override
  public Iterable<net.datastructures.Entry<K,V>> entrySet() {
    ArrayList<net.datastructures.Entry<K,V>> buffer = new ArrayList<>(size());
    for (Position<net.datastructures.Entry<K,V>> p : tree.inorder())
   ...
   */
  @Override
  public Iterable<net.datastructures.Entry<K,V>> subMap(K fromKey, K toKey) throws IllegalArgumentException {
  ...
  private void subMapRecurse(K fromKey, K toKey, Position<net.datastructures.Entry<K,V>> p,
                              ArrayList<net.datastructures.Entry<K,V>> buffer) {
    if (isInternal(p))
   ...
   */
  protected void rebalanceInsert(Position<net.datastructures.Entry<K,V>> p) { }
   ...
   */
  protected void rebalanceDelete(Position<net.datastructures.Entry<K,V>> p) { }
   ...
   */
  protected void rebalanceAccess(Position<net.datastructures.Entry<K,V>> p) { }
